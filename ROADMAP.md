...
> **Đang ở:** GĐ5 — **Phần A ✅** (giọng Piper, 223 test) + **Phần B ✅** (mastery/SR/scaffolding, 304 test). Kế tiếp: **Phần C (Bảng phụ huynh 2.0)** — tiêu thụ data mastery của B (dashboard Đã thạo/Đang lên/Nên luyện + thẻ tuần + gợi ý đời thực).
