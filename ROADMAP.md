...
- ☐ **Phần B — Chiều sâu học tập**: mastery từng-mục (Dexie) + lặp lại ngắt quãng + phản hồi gợi-ý-dạy (giảm lựa chọn khi sai + gợi ý có giọng).
- ☐ **Phần C — Bảng phụ huynh 2.0**: dashboard mastery (Đã thạo/Đang lên/Nên luyện) + thẻ tổng kết tuần + gợi ý chơi ngoài đời + privacy-là-tính-năng + nhắc dùng lành mạnh.
...
> **Đang ở:** GĐ5 — **Phần A xong ✅** (giọng Piper, 223 test). Kế tiếp: brainstorm **Phần B (Chiều sâu học tập)** — mastery từng-mục + lặp lại ngắt quãng + phản hồi gợi-ý-dạy.
